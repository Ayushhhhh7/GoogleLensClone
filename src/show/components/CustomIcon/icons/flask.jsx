...
const Flask = props => (
  <Svg width={32} height={32} fill="#aac5f2" viewBox="0 0 256 256" {...props}>
    ...
    <Path d="m48 208 28.54-47.58c14.25-1.74 30.31 1.85 47.82 10.72 19 9.61 35 12.88 48 12.88a69.89 69.89 0 0 0 19.55-2.7L208 208Z" />
  </Svg>
);
